...
SRC_DATASET="${BENCH_DIR}/levinson_durbin_dataset.ml"
SRC="${BENCH_DIR}/levinson_durbin.ml"
OUT="${RUNNING_OCAML_OUTPUT:-${BENCH_DIR}/levinson_durbin.opt}"
...
mkdir -p "$(dirname "${OUT}")"
# Dataset module must be compiled first; levinson_durbin.ml references Levinson_durbin_dataset.
